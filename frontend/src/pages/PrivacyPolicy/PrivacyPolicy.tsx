...
import styles from "./PrivacyPolici.module.css";
  ...
  return (
    <div>
      <section className={styles.section}>
        ...
        <p>
          At <span className={styles.text_acent}>Lex Ivanenko</span>, we value
          ...
          our services. We are committed to ensuring your privacy is safeguarded
