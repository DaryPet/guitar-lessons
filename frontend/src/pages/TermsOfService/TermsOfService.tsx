  ...
  return (
    <div>
      <section className={styles.section}>
        ...
        <p>
          Welcome to <span className={styles.text_acent}>Lex Ivanenko</span>{" "}
          lessons web! By accessing or using our website and services, you agree
          to comply with these Terms of Service. Please read the following terms
