...
const BASE_URL = "https://guitar-lessons-i99p.onrender.com";
...
// Endpoint для получения истории чата между двумя пользователями
export const CHAT_HISTORY_URL = `${CHAT_API_URL}history`;

// Endpoint для отправки сообщения
export const CHAT_SEND_MESSAGE_URL = `${CHAT_API_URL}send`;

// Примеры существующих URL для авторизации и т. д.
export const AUTH_LOGIN_URL = `${AUTH_API_URL}login`;
export const AUTH_LOGOUT_URL = `${AUTH_API_URL}logout`;
export const AUTH_REGISTER_URL = `${AUTH_API_URL}register`;
export const AUTH_REFRESH_URL = `${AUTH_API_URL}refresh`;
